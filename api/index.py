...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        try:
            ...
            response = {
                "status": "success",
                "message": "Aadhaar 2 Info Tool Running 🔥",
                "output": output if output else "Tool decrypted & loaded"
            }
    ...
    def do_POST(self):
        # POST requests ke liye (Aadhaar number bhej sakte ho)
        self.send_response(200)
        self.send_header('Content-type', 'application/json')
        self.end_headers()
        ...
        try:
            ...
            response = {
                "status": "success",
                "message": "POST received - Tool executed"
            }
        except Exception as e:
            response = {"status": "error", "message": str(e)}
